...
<!-- mcp-name: ai.trendsmcp/amazon-trends-mcp -->

<img src="https://www.trendsmcp.ai/static/pages/trendsmcp/assets/trend.svg" width="72" alt="Amazon Trends MCP logo">

# Amazon Trends MCP

Live trend data for AI agents. Google, TikTok, YouTube, Amazon, Reddit, and 30+ other sources. One MCP connection, one API key.

[![PyPI](https://img.shields.io/pypi/v/amazon-trends-mcp)](https://pypi.org/project/amazon-trends-mcp/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)
[![CI](https://github.com/trendsmcp-ai/amazon-trends-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/trendsmcp-ai/amazon-trends-mcp/actions/workflows/ci.yml)
...
[![Glama](https://glama.ai/mcp/servers/trendsmcp-ai/amazon-trends-mcp/badges/score.svg)](https://glama.ai/mcp/servers/trendsmcp-ai/amazon-trends-mcp)

[Get a free API key](https://www.trendsmcp.ai/account) · [Docs](https://www.trendsmcp.ai/docs) · [Pricing](https://www.trendsmcp.ai/pricing) · [Data sources](https://www.trendsmcp.ai/data-sources) · [PyPI](https://pypi.org/project/amazon-trends-mcp/) · [Glama](https://glama.ai/mcp/servers/trendsmcp-ai/amazon-trends-mcp)
...
CI: [`.github/workflows/ci.yml`](.github/workflows/ci.yml). Security: [SECURITY.md](SECURITY.md). Issues: [github.com/trendsmcp-ai/amazon-trends-mcp/issues](https://github.com/trendsmcp-ai/amazon-trends-mcp/issues).
